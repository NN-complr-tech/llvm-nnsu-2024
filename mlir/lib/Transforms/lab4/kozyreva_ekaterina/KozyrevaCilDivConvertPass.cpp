...
class KozyrevaCilDivConvertPass
    : public PassWrapper<KozyrevaCilDivConvertPass,
                         OperationPass<LLVM::LLVMFuncOp>> {
public:
  StringRef getArgument() const final { return "kozyreva-cildiv-conv"; }
...
MLIR_DECLARE_EXPLICIT_TYPE_ID(KozyrevaCilDivConvertPass)
MLIR_DEFINE_EXPLICIT_TYPE_ID(KozyrevaCilDivConvertPass)

PassPluginLibraryInfo getKozyrevaCilDivConvertPassPluginInfo() {
  return {MLIR_PLUGIN_API_VERSION, "kozyreva-cildiv-conv", LLVM_VERSION_STRING,
          []() { PassRegistration<KozyrevaCilDivConvertPass>(); }};
}

extern "C" LLVM_ATTRIBUTE_WEAK PassPluginLibraryInfo mlirGetPassPluginInfo() {
  return getKozyrevaCilDivConvertPassPluginInfo();
}
