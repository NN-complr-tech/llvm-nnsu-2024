// RUN: mlir-opt -load-pass-plugin=%mlir_lib_dir/KalininAlexandrFMAPass%shlibext --pass-pipeline="builtin.module(llvm.func(kalinin_alexandr_fma))" %s | FileCheck %s
...
// double func5(double a, double b, double c) {
  // double mul = a * b;
  // return mul + mul;
// }
