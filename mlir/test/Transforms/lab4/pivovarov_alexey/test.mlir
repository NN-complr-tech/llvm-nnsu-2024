// RUN: mlir-opt -load-pass-plugin=%mlir_lib_dir/PivovarovMergePass%shlibext --pass-pipeline="builtin.module(llvm.func(pivovarov-combine-mul-add))" %s | FileCheck %s
...
// double func3(double a, double b) {
  ...
  // return result;
// }
// double func4(double a, double b, double c) {
  // double mul = a * b;
  // return mul + mul;
// }
