...
body:             |
  bb.0.entry:
    ...
    $r10 = ADD64ri32 $r10, 3, implicit-def $eflags
  ...
  bb.1.for.body.preheader:
    ...
    $r10 = ADD64ri32 $r10, 4, implicit-def $eflags
  ...
  bb.2:
    ...
    $r10 = ADD64ri32 $r10, 1, implicit-def $eflags
  ...
  bb.3.for.cond.cleanup.loopexit.unr-lcssa:
    ...
    $r10 = ADD64ri32 $r10, 2, implicit-def $eflags
    JCC_1 %bb.5, 4, implicit $eflags
  
  bb.4.for.body.epil (align 16):
    ...
    $r10 = ADD64ri32 $r10, 5, implicit-def $eflags
  ...
  bb.8.for.body (align 16):
    successors: %bb.3(0x04000000), %bb.9(0x7c000000)
  ...
  bb.11.for.body:
    ...
    $r10 = ADD64ri32 $r10, 4, implicit-def $eflags
    JCC_1 %bb.13, 12, implicit $eflags
  ...
  bb.13.for.body:
    ...
    CMP32rr renamable $eax, renamable $esi, implicit-def $eflags
    $r10 = ADD64ri32 $r10, 4, implicit-def $eflags
    JCC_1 %bb.15, 12, implicit $eflags
  ...
  bb.15.for.body:
    successors: %bb.16(0x40000000), %bb.8(0x40000000)
    liveins: $eax, $ecx, $edi, $edx, $esi, $r8d
...
body:             |
  bb.0.entry:
    ...
    $r10 = ADD64ri32 $r10, 36, implicit-def $eflags
    JCC_1 %bb.5, 4, implicit $eflags
  ...
  bb.4._ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit:
    ...
    $r10 = ADD64ri32 $r10, 13, implicit-def $eflags
    RET64 $eax
...
body:             |
  bb.0.entry:
    ...
    frame-destroy CFI_INSTRUCTION def_cfa_offset 8
    $r10 = ADD64ri32 $r10, 7, implicit-def $eflags
