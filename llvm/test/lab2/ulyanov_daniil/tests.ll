...
; CHECK-NEXT: %3 = alloca i32, align 4
; CHECK-NEXT: store i32 %0, ptr %2, align 4
; CHECK-NEXT: store i32 45, ptr %3, align 4
; CHECK-NEXT: %4 = load i32, ptr %2, align 4
; CHECK-NEXT: %5 = shl i32 %4, 5
...
; CHECK-NEXT: store i32 %5, ptr %3, align 4
; CHECK-NEXT: %6 = load i32, ptr %3, align 4
; CHECK-NEXT: %7 = shl i32 %6, 6
; CHECK-NEXT: store i32 %7, ptr %3, align 4
; CHECK-NEXT: %8 = load i32, ptr %2, align 4
; CHECK-NEXT: %9 = mul nsw i32 %8, 7
; CHECK-NEXT: store i32 %9, ptr %2, align 4
; CHECK-NEXT: %10 = load i32, ptr %3, align 4
; CHECK-NEXT: %11 = shl i32 %10, 7
; CHECK-NEXT: store i32 %11, ptr %3, align 4
; CHECK-NEXT: %12 = load i32, ptr %2, align 4
; CHECK-NEXT: %13 = shl i32 %12, 8
; CHECK-NEXT: store i32 %13, ptr %2, align 4
; CHECK-NEXT: %14 = load i32, ptr %2, align 4
; CHECK-NEXT: %15 = mul nsw i32 %14, 15
; CHECK-NEXT: store i32 %15, ptr %2, align 4
; CHECK-NEXT: ret void
