; RUN: split-file %s %t
; RUN: opt -passes="kulagin-magic-inline" -S %t/test1.ll | FileCheck %t/test1.ll
; RUN: opt -passes="kulagin-magic-inline" -S %t/test2.ll | FileCheck %t/test2.ll
; RUN: opt -passes="kulagin-magic-inline" -S %t/test3.ll | FileCheck %t/test3.ll
; RUN: opt -passes="kulagin-magic-inline" -S %t/test4.ll | FileCheck %t/test4.ll
; RUN: opt -passes="kulagin-magic-inline" -S %t/test5.ll | FileCheck %t/test5.ll
; RUN: opt -passes="kulagin-magic-inline" -S %t/test6.ll | FileCheck %t/test6.ll
; RUN: opt -passes="kulagin-magic-inline" -S %t/test7.ll | FileCheck %t/test7.ll
; RUN: opt -passes="kulagin-magic-inline" -S %t/test8.ll | FileCheck %t/test8.ll
