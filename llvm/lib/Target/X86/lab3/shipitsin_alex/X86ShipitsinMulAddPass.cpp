...
#define X86_MULADD_PASS_NAME "X86 Shipitsin muladd pass"

namespace {
class X86ShipitsinMulAddPass : public MachineFunctionPass {
public:
  static char ID;

  X86ShipitsinMulAddPass() : MachineFunctionPass(ID) {}
...
char X86ShipitsinMulAddPass::ID = 0;

bool X86ShipitsinMulAddPass::runOnMachineFunction(llvm::MachineFunction &MF) {
...
static RegisterPass<X86ShipitsinMulAddPass> X("x86-Shipitsin-muladd",
